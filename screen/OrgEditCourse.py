...
# Form implementation generated from reading ui file 'EditCourse.ui',
# licensing of 'EditCourse.ui' applies.
#
# Created: Wed May 29 13:00:46 2019
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        brush = QtGui.QBrush(QtGui.QColor(185, 187, 240))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.Button, brush)
        brush = QtGui.QBrush(QtGui.QColor(255, 255, 255))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.Light, brush)
        brush = QtGui.QBrush(QtGui.QColor(220, 221, 247))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.Midlight, brush)
        brush = QtGui.QBrush(QtGui.QColor(92, 93, 120))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.Dark, brush)
        brush = QtGui.QBrush(QtGui.QColor(123, 125, 160))
        brush.setStyle(QtCore.Qt.SolidPattern)
        ...
        self.label.setGeometry(QtCore.QRect(30, 30, 1011, 61))
        font = QtGui.QFont()
        ...
        self.title.setGeometry(QtCore.QRect(240, 110, 791, 51))
        font = QtGui.QFont()
        font.setPointSize(15)
        ...
        self.speaker.setGeometry(QtCore.QRect(240, 170, 791, 51))
        font = QtGui.QFont()
        font.setPointSize(15)
        ...
        self.label_4.setGeometry(QtCore.QRect(90, 230, 151, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.label_4.setFont(font)
        self.label_4.setObjectName("label_4")
        self.details = QtWidgets.QLineEdit(self.widget)
        self.details.setGeometry(QtCore.QRect(240, 400, 791, 161))
        font = QtGui.QFont()
        font.setPointSize(15)
        ...
        self.label_5.setGeometry(QtCore.QRect(90, 290, 151, 40))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.label_5.setFont(font)
        self.label_5.setObjectName("label_5")
        self.label_6 = QtWidgets.QLabel(self.widget)
        self.label_6.setGeometry(QtCore.QRect(90, 340, 151, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.tag.setGeometry(QtCore.QRect(240, 280, 791, 51))
        font = QtGui.QFont()
        font.setPointSize(15)
        ...
        self.datetime.setGeometry(QtCore.QRect(240, 230, 231, 41))
        font = QtGui.QFont()
        font.setPointSize(15)
        self.datetime.setFont(font)
        self.datetime.setObjectName("datetime")
        self.type = QtWidgets.QComboBox(self.widget)
        self.type.setGeometry(QtCore.QRect(240, 340, 791, 51))
    ...
    def retranslateUi(self, Form):
        ...
        self.save.setText(QtWidgets.QApplication.translate("Form", "Save and Update", None, -1))
        self.label.setText(QtWidgets.QApplication.translate("Form", "Edit Course", None, -1))
